...
url = 'https://www.nullreferer.com/?http://www.imhd.sk/ba/online-zastavkova-tabula?st='
...
while i < 5000:
    ...
    if text == '[]':
        ...
        li = '<li><a href="https://www.nullreferer.com/?' + link + '"><strong class="name">' + lowercase + '</strong>' + title \
             + '</a></li>'
